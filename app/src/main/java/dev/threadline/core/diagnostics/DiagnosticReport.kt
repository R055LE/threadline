...
private fun SessionError.diagnosticCode(): String = when (this) {
    ...
    SessionError.DnsResolutionFailed -> "dns_resolution_failed"
    SessionError.ConnectionTimedOut -> "connection_timed_out"
    SessionError.ConnectionRefused -> "connection_refused"
